<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SolicitarGastoPresupuesto.aspx.cs" Inherits="ProyectoAdmin.pages.SolicitarPresupuesto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <link  href="../../Estilos/Departamentos/SolicitarGastoPresupuesto.css" rel="stylesheet" />
</asp:Content>
        ...
        <form runat="server">
             <div style="margin-left:25px;">
                ...
                <div style="display:flex">
                    <h3 class="solicitado" style="margin-right:10px">Partidas</h3>
                    <h3 class="fechaSolicitud" style="margin-right:10px">Monto a solicitar</h3>   
                </div>
